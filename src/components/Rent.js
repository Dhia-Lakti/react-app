...
const Rent = () => {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:8000/articles/RENT", {
      headers: {
          ...
          <div class="live-stream">
            <div class="col-lg-12">
              <div class="heading-section">
                <h4><em>All Houses</em> For Rent</h4>
              </div>
            </div>
            <div class="row">
            {RentalArticles.map((article) => (
                                      ...
                                      <div class="item">
                                        <div class="thumb">
                                          ...
                                          <div class="hover-effect">
                                            <div class="content">
                                              <ul>
                                                <li><a href="aa"><i class="fa fa-usd"></i> {article.price}</a></li>
